...
namespace Budgeter.Controllers
{
    ...
    public class InvitesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,HouseholdId,UserEmail,InviteCode")] Invite invite)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,HouseholdId,UserEmail,InviteCode")] Invite invite)
        {
            if (ModelState.IsValid)
            {
